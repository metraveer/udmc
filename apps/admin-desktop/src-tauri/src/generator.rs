...
/// The mod version belongs in the name. A mods folder holding two UDMC files and no version
/// in either name cannot be sorted out by the person looking at it, and "which file do you
